...
describe('四个会议链式重叠 - 冲突均标红', () => {
    ...
    it('1 A 2 A 3 A 4 A => 1 x 2 x 3 x 4 x', () => {
    ...
    it('1 A 2 A 3 A 4 A -> 1 null => 2 x 3 x 4 x', () => {
    ...
    it('1 A 2 A 3 A 4 A -> 2 null => 3 x 4 x', () => {
    ...
    it('1 A 2 A 3 A 4 A -> 3 null => 1 x 2 x', () => {
    ...
    it('1 A 2 A 3 A 4 A -> 4 null => 1 x 2 x 3 x', () => {
    ...
    it('1 A 2 A 3 A 4 A -> 1 B => 2 x 3 x 4 x', () => {
    ...
    it('1 A 2 A 3 A 4 A -> 2 B => 3 x 4 x', () => {
    ...
    it('1 A 2 A 3 A 4 A -> 3 B => 1 x 2 x', () => {
    ...
    it('1 A 2 A 3 A 4 A -> 4 B => 1 x 2 x 3 x', () => {
